...
import { Typography, Button, Card, CardContent, MenuItem, InputAdornment, Avatar, IconButton } from '@material-ui/core';
                                               ...
                                               <CardContent className="text-center text-md-left p-1">
	                                                <div className="row w-100">
	                                                	<div className="col-12 d-flex justify-content-around align-items-center">
		                                                    <Avatar src={user1} className={classes.avatar} variant="rounded" alt="contact" />
			                                                <div>
			                                                   <Typography
			                                                       variant="h6"
			                                                       display="block"
			                                                   ...
			                                                   >
		                                                   		...
		                                                   		<div className={`text-center ${classes.rating}`}>
			                                                   		<IconButton aria-label="rating" component="span" color={doctor.rating>0?'primary':'default'} edge="start">
											                          	<StarRoundedIcon />
											                        </IconButton>
	                                                ...
	                                                <div className="row mt-3 text-left">
	                                                	<div className="col-12">
	                                                		<Typography variant="caption" className="my-2 mx-3" color="primary" display="block">
