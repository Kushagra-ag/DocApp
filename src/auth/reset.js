...
function Form() {
  ...
  return(
    <form className={classes.form} method="POST">
            ...
            <AuthTextField id="otp" label="otp" className={classes.margin} disableUnderline color="primary" placeholder="OTP" required style={{display:display}} />
            <Button variant="contained" className={`${classes.margin} ${classes.facebook}`} type={type} onClick={stateChange}>
      ...
      <div className="row" style={{minHeight:height}}>
          ...
          <div className="row">
            <div className="col-12 d-flex flex-column justify-content-center text-left text-md-center">
              ...
              <Typography variant="subtitle1" color={txt} gutterBottom>
                We will help you recover your <br/>password.
        ...
        <div className="col-md-6 d-flex justify-content-center align-items-center" style={{backgroundColor:'#F4F5FB'}}>
          <div className="d-flex flex-column">
            ...
            <Button variant="outlined" className={`${classes.margin}`} style={{backgroundColor: '#fff'}} component={Link} to='#'>
              <Typography variant="caption" className={classes.margin}>
                Call Us
              </Typography>
            </Button> 
