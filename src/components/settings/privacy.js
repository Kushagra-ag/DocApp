...
import {Typography, IconButton, Card, CardContent, CardActions, Collapse } from '@material-ui/core';
	...
	return(
		<>
			<Card className="my-3 text-left">
			    ...
			    <div className="row">
					<Collapse className="col-12" in={props.expanded} timeout="auto" unmountOnExit>
				        <CardContent>
				        	<div className="d-flex justify-content-between">
